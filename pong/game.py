...
class Game:
    ...
    def __perform_paddle_hit_checking(self):
        ...
        hit_paddle_a = (a_x + self.paddle_width) == x \
                       and ((a_y - self.paddle_height / 2) <=
                            y <= (a_y + self.paddle_height / 2))

        hit_paddle_b = (b_x - self.paddle_width) == x \
                       and ((b_y - self.paddle_height / 2) <=
                            y <= (b_y + self.paddle_height / 2))
